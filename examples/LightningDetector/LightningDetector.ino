...
// Library object initialization First argument is interrupt (0 = pin 2, 1 = pin 3 on UNO), second is device I2C address
AS3935 AS3935(0,0x03);
...
void setup()
{
	...
	// we are using pin 2 (interrupt 0)
	pinMode(2, INPUT);
	...
	if(AS3935.calibrate()) {
		Serial.print("Tune:"); Serial.println(AS3935.getTune());
	} else {
